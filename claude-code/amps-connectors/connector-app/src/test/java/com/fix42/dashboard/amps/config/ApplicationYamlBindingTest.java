...
import com.fix42.dashboard.amps.app.ConnectorApplication;
 ...
 * this test is about the configuration model, not about running connectors. The deployable
 * per-application files under {@code config/} get the same treatment in {@code ConfigTreeTest}.
 */
@SpringBootTest(classes = ConnectorApplication.class, properties = "amps.enabled=false")
@ActiveProfiles("demo")
