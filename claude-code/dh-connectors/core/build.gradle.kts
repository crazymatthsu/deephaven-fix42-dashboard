// :dh-connectors:core -- the source -> Deephaven pipeline as a LIBRARY (doc 07).
//
...
// baked application.yml. Core contributes its beans through
// ConnectorsAutoConfiguration instead, and ships its shared test doubles
// (FakeRecordSource, RecordingDeephavenGateway, TestConnectors) as test fixtures.
//
// No transport client is a dependency here: each lives in its own :dh-connectors:source-*
// module and reaches core through the SourceFactory SPI, so core compiles and tests
