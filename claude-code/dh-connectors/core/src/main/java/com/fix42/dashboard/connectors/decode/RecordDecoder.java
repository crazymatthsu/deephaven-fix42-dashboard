...
public interface RecordDecoder {
    ...
    /**
     * Decode a whole record. The default reads {@link SourceRecord#data()}; a decoder for a
     * multi-part format overrides this to read {@link SourceRecord#parts()} instead.
     *
     * @param record the record as the subscriber delivered it
     * @return the fields it carried, keyed by tag
     * @throws IllegalArgumentException if the payload is malformed for this format
     */
    default Map<String, String> decode(SourceRecord record) {
