package com.fix42.dashboard.connectors.deephaven;

import com.fix42.dashboard.connectors.config.DeephavenTableType;
import com.fix42.dashboard.connectors.mapping.ColumnSpec;
...
public final class TableBootstrapScript {
    ...
    public static String createIfMissing(TableSchema schema, String connectorName) {
        ...
        String id = "[dh-connectors] " + connectorName + ": ";
    ...
    private static void appendPublisherCreation(
        ...
        script.append("    ").append(blink).append(", ").append(publisherName(table))
                .append(" = table_publisher(").append(quote("dh-connectors:" + table))
    ...
    public static String probe(List<String> tableNames) {
        ...
        script.append("    raise RuntimeError(")
                .append(quote("[dh-connectors] tables missing from the python scope: "))
