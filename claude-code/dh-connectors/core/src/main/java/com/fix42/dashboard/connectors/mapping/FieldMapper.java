...
public final class FieldMapper {
     ...
     */
    public MappedRow map(SourceRecord record, Map<String, String> fields, Instant ingestTime) {
        ...
        MappedRow.Action action = record.action() == SourceRecord.Action.DELETE
