...
/**
 * The whole application wired as it runs, with the simulated source at one end and a
...
class EndToEndPipelineTest {
    ...
    private ConnectorManager manager(ConnectorProperties... connectors) {
        ...
        ConnectorManager manager = new ConnectorManager(
                ...
                // The real resolver, over no factories at all: SIMULATED is exactly the
                // case core has to serve without a source module on the classpath.
