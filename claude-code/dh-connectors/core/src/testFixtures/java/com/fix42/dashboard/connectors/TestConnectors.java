...
import com.fix42.dashboard.connectors.config.DeephavenTableProperties;
...
public final class TestConnectors {
    ...
    public static ConnectorProperties compositeOrders() {
        ...
        connector.getSource().getAmps().setMessageType("composite-json-fix");
    ...
    private static ConnectorProperties base(
        ...
        source.setAmps(amps);
        source.setDriver(SourceProperties.Driver.SIMULATED);
