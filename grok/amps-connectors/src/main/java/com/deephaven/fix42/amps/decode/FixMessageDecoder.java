...
/** AMPS FIX: numeric tags. Only configured tags are returned. */
public final class FixMessageDecoder implements MessageDecoder {
    private final Set<String> wantedSources;

    public FixMessageDecoder(Set<String> wantedSources) {
